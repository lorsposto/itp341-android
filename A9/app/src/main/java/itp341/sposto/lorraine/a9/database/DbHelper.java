package itp341.sposto.lorraine.a9.database;
...
import itp341.sposto.lorraine.a9.database.DbSchema.TABLE_POWERS;
import itp341.sposto.lorraine.a9.database.DbSchema.TABLE_HEROES;
    ...
    public DbHelper(Context context) {
        ...
        if (!databaseFile.exists()) {
            try {
                ...
                Log.d(TAG, "Done copying database.");
            } catch (IOException e) {
